...
int main () {
    ...
    */
    ...
    // pseudocode
    // input : list of rectangles : l
    // output: overlap of rectangles :a
    //
    // clist contains all the x coordinates from all rectangles, each x coordinate has a reference too its rectangle
    // int n = size of clist
    //
    // for i <- 0 to n do {
    //     if clist[i] == clist[i].rectangle.left then
    //          m <- size (clist)
    //          for j <- 0 to m do [
