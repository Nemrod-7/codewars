...
map<char,int> base = {{'A', 0},{'B', 0},{'C', 0},{'D', 1},{'E', 1},{'F', 1}, {'G', 2},{'H', 2},{'I', 2}, {'J', 3},{'K', 3},{'L', 3}, {'M', 4},{'N', 4},{'O', 4}, {'P', 5},{'Q', 5},{'R', 5},{'S', 5},{'T', 6},{'U', 6},{'V', 6},{'W', 7},{'X', 7},{'Y', 7},{'Z', 7}};
...
set<string> check1800 (const string &str) {

    string sub = str.substr (6);
    vector<string> pref, post;
    set<string> out;

    sub.erase (remove (sub.begin(), sub.end(), '-'), sub.end());
    pref = search (sub.substr (0, 3));
    post = search (sub.substr (3));
    ...
    pref = search (sub.substr (0, 4));
    post = search (sub.substr (4));
