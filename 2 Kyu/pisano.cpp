...
vector<uint64_t> divisors (const uint64_t N) { // returns all divisors of N
...
pair<int64_t,int64_t> fibonacci (int64_t n, int64_t mod) {
...
int main () {
    ...
    uint64_t N = 2438389198053, res = 10624179384;
